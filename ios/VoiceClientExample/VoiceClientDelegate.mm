...
void VoiceClientDelegate::Login(){
    stun_config_.stun = "xmpp1.tuenti.com:3478";
    AppDelegate* appDelegate = (AppDelegate*)[UIApplication sharedApplication].delegate;
    voiceClient_->Login([[appDelegate.myJid full] cStringUsingEncoding:NSUTF8StringEncoding], [appDelegate.password cStringUsingEncoding:NSUTF8StringEncoding], &stun_config_, "talk.google.com", 5222, true, 0, false/*isGtalk*/);
}
