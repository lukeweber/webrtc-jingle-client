...
//static const int xmppLogLevel = XMPP_LOG_LEVEL_VERBOSE | XMPP_LOG_FLAG_SEND_RECV;
...
- (id)init
{
	if ((self = [super init]))
	{
		...
		// Initialize socket
        [[GCDAsyncSocketMultiDelegate instance] addDelegate:self];
		asyncSocket = [[GCDAsyncSocket alloc] initWithDelegate:[GCDAsyncSocketMultiDelegate instance] delegateQueue:xmppQueue];
        [GCDAsyncSocketMultiDelegate instance].socket = asyncSocket;
	}
	return self;
}
