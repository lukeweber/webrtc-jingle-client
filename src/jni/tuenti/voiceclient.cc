...
void VoiceClient::InitializeS() {
    ...
    if (client_signaling_thread_ == NULL) {
        ...
        LOGI(
                "VoiceClient::VoiceClient - new ClientSignalingThread client_signaling_thread_@(0x%x)", client_signaling_thread_);
...
void VoiceClient::DestroyS() {
    ...
    if (client_signaling_thread_ != NULL) {
        LOGI(
                "VoiceClient::VoiceClient - destroy ClientSignalingThread client_signaling_thread_@(0x%x)", client_signaling_thread_);
