...
deps = {
  ...
  "trunk/third_party/libjingle": "https://github.com/lukeweber/libjingle-override.git@bbced5a",
  ...
  "trunk/third_party/webrtc": "https://github.com/lukeweber/webrtc-src-override.git@6829a7",
