...
if [ "$BUILDSYSTEM" == "gyp" ]; then
  ...
  echo -e "-------------------------------\nBUILDING/INSTALLING\n-------------------------------";
  mkdir -p $ANDROIDDIR/voice-client-core/libs/armeabi
  mkdir -p $ANDROIDDIR/voice-client-core/libs/armeabi-v7a
  mkdir -p $ANDROIDDIR/voice-client-core/libs/x86
  mkdir -p $ANDROIDDIR/voice-client-core/obj/armeabi
  mkdir -p $ANDROIDDIR/voice-client-core/obj/armeabi-v7a
  mkdir -p $ANDROIDDIR/voice-client-core/obj/x86
  ...
  pushd $ANDROIDDIR/voice-client-core/jni
